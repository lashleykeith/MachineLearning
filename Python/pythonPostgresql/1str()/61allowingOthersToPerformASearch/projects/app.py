...
app = Flask(__name__)
app.secret_key = '14Snacktime'

Database.initialise(host='localhost', database='learning', user='postgres', password='14Snacktime')
...
@app.route('/search') # http://127.00.1.:4955/search?q=cars+filter:images
def search():
